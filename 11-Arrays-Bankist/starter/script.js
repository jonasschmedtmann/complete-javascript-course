...
///* set have no keys, therefore the first two arguments are both value for sets*/
...
const diceRolls = Array.from({ length: 100 }, _ =>
...
puppy. A dog is an adult if it is at least 3 years old, and it's a puppy if it's
...
3. For each remaining dog, log to the console whether it's an adult ("Dog number
 1 is an adult, and is 5 years old") or a puppy ("Dog number 2 is still a 
puppy 🐶")
...
//const checkAges = function (dogsJulia, dogsKate) {
//  const correctedDogArr = [dogsJulia.slice(2, -2)];
//  const combinedDogArr = [...correctedDogArr, ...dogsKate];
//  combinedDogArr.forEach(function (age, i) {
//    console.log(
//      `${
//        age >= 3
...
//};
//
//checkAges([3, 5, 2, 12, 7], [4, 1, 15, 8, 3]);
//checkAges([9, 16, 6, 8, 3], [10, 5, 6, 1, 4]);
...
create a new array, simply loop over the array. Forumla: 
recommendedFood = weight ** 0.75 * 28. (The result is in grams of food, and the 
weight needs to be in kg)
2. Find Sarah's dog and log to the console whether it's eating too much or too 
little. HINT: Some dogs have multiple owners, so you first need to find Sarah 
...
/* Q8 */
const sortedDogsbyRecFood = dogs
  .slice()
  .sort((dogA, dogB) => dogA.recommendedFood - dogB.recommendedFood);

console.log(sortedDogsbyRecFood);
/////////////////////////////////////////////////
/////////////////////////////////////////////////
// BANKIST APP
...
//
//const balance = movements.reduce((acu, mov) => acu + mov, 0);
//console.log(balance);
//
...
//  .reduce((acu, mov) => acu + mov, 0);
//console.log(parseInt(totalDeposits));
...
btnClose.addEventListener('click', function (event) {
  ...
  if (
    ...
    alert('Invalid User: Accounts can only be closed by the owner.');
  }
...
const totalBankBalanceToo = accounts
  .flatMap(acc => acc.movements)
  .reduce((acu, mov) => acu + mov, 0);

console.log(totalBankBalanceToo);
