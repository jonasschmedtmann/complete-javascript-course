...
//Reprents a weekly schedule as a SWITCH statement//
const day = "thursday";
...
//Reprents a weekly schedule as an IF statement
...
const me = "Jonas";//expressions
console.log(`I'm ${2037 - 1991} years old. ${me}`);



//LESSON; THE CONDITIONAL (TERNARY) OPERATOR//
//hint-TERNARY allows an if statement but in one line//
...
// // const bill = 275; // bill = 275, tip = 41.25, FV = 316.25//
// // const bill = Number(40); // bill = 40, tip = 8, FV = 48//
// const bill = Number(430); //bill = 430, tip = 86, FV = 516//
...
// console.log(`The bill was (${bill}), the tip was (${tip}), and the final value is (${finalValue}).`)
