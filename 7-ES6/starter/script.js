...
// ES6 -- adding/creating the subclasses for Person6
class Person6 {
    constructor (name, yearOfBirth, job){
        this.name = name;
        this.yearOfBirth = yearOfBirth;
...
class Athlete6 extends Person6 {
    constructor(name, yearOfBirth, job, olympicGames, medals){
        super(name, yearOfBirth, job); // calls the super, don't have to manually set the this variable
        this.olympicGames = olympicGames;
        this.medals = medals;
    }
...
const zackAthlete6 = new Athlete6('zack', 1997, 'swimmer', 2, 7);
